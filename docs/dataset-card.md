...
This card describes the preserved historical horizon sample. Its original validator pass is an integrity result, not verification of visual inspection/search semantics. Current generation and stricter publication gates are documented in [engineering notes](engineering-notes.md).
